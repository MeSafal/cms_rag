                                    ...
                                    <div class="card-body p-0 pb-2">
                                        <div class="w-100">
                                            <div id="customer_impression_charts"
                                                data-colors='["--cms-secondary", "--cms-primary", "--cms-primary-rgb, 0.50"]'
                                ...
                                <div class="card card-height-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div id="sales-by-locations"
                                            data-colors='["--cms-light", "--cms-secondary", "--cms-primary"]'
                                ...
                                <div class="card card-height-100">
                                    ...
                                    <div class="card-body">
                                        <div id="store-visits-source"
                                            data-colors='["--cms-primary", "--cms-primary-rgb, 0.85", "--cms-primary-rgb, 0.70", "--cms-primary-rgb, 0.60", "--cms-primary-rgb, 0.45"]'
                                            class="apex-charts" dir="ltr"></div>
                                    </div>
                                </div> <!-- .card-->
                            </div> <!-- .col-->
