...
@include( frontendPath() . '.partials.navMenu')
@include( frontendPath() . '.menu.slider')
<head>

    <!-- Libraries Stylesheet -->
    <link href="{{ asset('extras/lib/owlcarousel/assets/owl.carousel.min.css') }}" rel="stylesheet">

    <!-- Customized Bootstrap Stylesheet -->
    <link href="{{ asset('extras/lib/bootstrap.min.css') }}" rel="stylesheet">

    <!-- Template Stylesheet -->
    <link href="{{ asset('extras/lib/style.css') }}" rel="stylesheet">
</head>
...
<body>
    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-8">
                <!-- Blog Detail Start -->
                <div class="mb-5">
                    <img class="img-fluid w-100 rounded mb-5" src="{{asset('photos\1\coffee\coffee_1.jpg')}}" alt="">
                    <h1 class="text-uppercase mb-4">{{$content->title}}</h1>
                    {!! $content->description !!}
                </div>
                <!-- Blog Detail End -->
    ...
    <!-- Easing Library -->
    <script src="{{ asset('extras/lib/easing/easing.min.js') }}"></script>

    <!-- Waypoints Library -->
    <script src="{{ asset('extras/lib/waypoints/waypoints.min.js') }}"></script>

    <!-- Owl Carousel Library -->
    <script src="{{ asset('extras/lib/owlcarousel/owl.carousel.min.js') }}"></script>

    <!-- Template Javascript -->
    <script src="{{ asset('extras/lib/main.js') }}"></script>
</body>
