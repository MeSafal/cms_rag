...
<!-- resources/views/backend/coachings/create.blade.php -->
        ...
        <div class="row g-4">
            <div class="col-sm-12 col-xl-8">
                <div class="rounded h-100 p-4">
                    ...
                    <h5 class="mb-4">
                        @if(isset($item))
                            Edit coaching <span class="text-primary">{{ $item->title }}</span>
                        @else
                            Create coaching
                        @endif
                    </h5>
                    <form
                        action="{{ isset($item) ? route('coachings.update', $item->coachings_id) : route('coachings.store') }}"
