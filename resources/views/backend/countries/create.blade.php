...
<!-- resources/views/backend/countries/create.blade.php -->
        ...
        <div class="row g-4">
            <div class="col-sm-12 col-xl-8">
                <div class="rounded h-100 p-4">
                    ...
                    <h5 class="mb-4">
                        @if(isset($item))
                            Edit country <span class="text-primary">{{ $item->title }}</span>
                        @else
                            Create country
                        @endif
                    </h5>
                    <form
                        action="{{ isset($item) ? route('countries.update', $item->countries_id) : route('countries.store') }}"
