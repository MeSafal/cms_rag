@php
    ...
    $head_color = '#FFF';
    $faded_color = '3px 6px 6px rgba(0, 0, 0, 0.3)';
    if (Auth::check()) {
        ...
        try {
            $hexColor = '#invalidhex'; // Example invalid input
            $formatted_color = hexToRgb($custom_color);
        } catch (InvalidArgumentException $e) {
            // Default fallback value
            $formatted_color = '3px 6px 6px rgba(0, 0, 0, 0.3)'; // Default black shadow
        }
    }
...
<style>
    .box-shadow {
        box-shadow: {{ $formatted_color }}
    }

    .selected-item input.main-template-radio:checked {
        outline: 2px solid {{$custom_color}};
        outline-offset: 3px;
    }
    ...
    /* Title container - hidden initially */
    .template-title {
        position: absolute;
        bottom: 0;
        left: 0;
    ...
    *::-webkit-scrollbar-thumb:hover {
    ...
    .nav-tabs .nav-link {
        cursor: grabbing;
        /* Ensures pointer behavior for inactive tabs */
    }

    .nav-tabs .nav-link.active {
        color: {{ $custom_color }} !important;
        /* Red text color for active tab */
        cursor: not-allowed;
        /* Disables pointer for active tab */
    }
    ...
    .hoverable-image {
        ...
        z-index: 1;
        /* Ensure hoverable images are layered above other content */
    }

    .hoverable-image:hover {
        transform: scale(5.44);
        /* Scales 45px to approx 200px */
        z-index: 10;
        /* Makes the hovered image appear above other elements */
        object-fit: cover;
        /* Ensures the image retains the same aspect ratio */
    }
    ...
    :root {
        ...
        --bs-primary: {{ $custom_color }};
        --bs-secondary: {{ $theme_color }};
    ...
    */ .table-light {
        ...
        --bs-table-striped-color: #{{ $dark_color }};
        --bs-table-active-bg: #7b809e;
        --bs-table-active-color: {{ $dark_color }};
        --bs-table-hover-bg: #777d9b;
        --bs-table-hover-color: {{ $dark_color }};
        color: {{ $head_color }};
        border-color: #7b809e
    }
    ...
    .bg-shadow {
        box-shadow: {{ $formatted_color }} !important
    }
 ...
 */
    ...
    *::after {
    ...
    .table-dark {
        ...
        --bs-table-striped-color: {{ $head_color }};
        --bs-table-active-bg: #1a1a1a;
        --bs-table-active-color: {{ $head_color }};
        --bs-table-hover-bg: #131313;
        --bs-table-hover-color: {{ $head_color }};
        color: {{ $head_color }};
        border-color: #1a1a1a
    }
    ...
    .card-header-tabs .nav-link.active {
        z-index: -100;
        background-color: {{ $head_color }};
        border-bottom-color: {{ $head_color }}
    }
    ...
    .alert-warning {
        color: #664d03;
        background-color: {{ $head_color }}3cd;
        border-color: #ffecb5
    }
    ...
    .border-white {
        border-color: {{ $head_color }} !important
    }
    ...
    .image-preview-container {
        width: 100%;
        justify-content: center;
        /* Centers images when there's no overflow */
        padding-top: 5px;
        /* Adjust if needed */
    }
    ...
    .image-preview {
        ...
        /* Prevents images from getting too small */
    }
