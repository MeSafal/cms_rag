   <header id="page-topbar">
    ...
    <button id="themeToggleAjaxBtn"
            type="button"
            class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle light-dark-mode"
            aria-pressed="false"
            title="Toggle theme">
        <i id="themeToggleIcon" class="bx bx-moon fs-22" aria-hidden="true"></i>
        <span class="visually-hidden">Toggle theme</span>
                   ...
                   <div class="dropdown ms-sm-3 header-item topbar-user">
                       <button type="button" class="btn" id="page-header-user-dropdown"
                           ...
                           <span class="d-flex align-items-center">
                               <img class="rounded-circle header-profile-user"
                                   src="{{ asset($settingArray['wprofile_image'] ?? 'img/user.jpg') }}"
                                   alt="User Image">
                               <span class="text-start ms-xl-2">
                                   {{-- <span
                                       class="d-none d-xl-inline-block ms-1 fw-semibold user-name-text">{{ Auth::user()->name }}</span>
                                   <span
                                       class="d-none d-xl-block ms-1 fs-12 user-name-sub-text">{{ Auth::user()->getRoleNames()->first() }}
                                   </span> --}}
                               </span>
                           </span>
                       </button>
                       <div class="dropdown-menu dropdown-menu-end">
                           ...
                           <a class="dropdown-item" href={{route('settings.edit')}}><span
                           ...
                           <form class="dropdown-item" action="{{ route('logout') }}" method="POST"
                               ...
                               @csrf
                               <button type="submit"
                                   class="w-100 text-start border-0 bg-transparent p-0 m-0 dropdown-item">
