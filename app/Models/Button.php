...
class Button extends Model
{
    ...
    protected $primaryKey = 'buttons_id';
    ...
    // {
    //     return $this->hasMany(Button::class, 'parent', 'buttons_id')->where('status', '<>', 0);
    // }

    // public function parent()
    // {
    //     return $this->belongsTo(Button::class, 'parent')->where('status', '<>', 0);
    // }
}
