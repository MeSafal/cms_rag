...
class Country extends Model
{
    ...
    // {
    //     return $this->hasMany(Country::class, 'parent', 'countries_id')->where('status', '<>', 0)->orderBy('display_order', 'asc');
    // }

    // public function parentItem()
    // {
    //     return $this->belongsTo(Country::class, 'parent')->where('status', '<>', 0);
    // }
}
