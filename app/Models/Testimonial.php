...
class Testimonial extends Model
{
    ...
    // {
    //     return $this->hasMany(Testimonial::class, 'parent', 'testimonials_id')->where('status', '<>', 0)->orderBy('display_order', 'asc');
    // }

    // public function parentItem()
    // {
    //     return $this->belongsTo(Testimonial::class, 'parent')->where('status', '<>', 0);
    // }
}
